...
class User
{
	...
	public function createUserAccount($username,$email,$password,$usertype){
		// To protect your aplication from sql attack you can use prepare statment
	...
	public function userLogin($email,$password){
		...
		if ($result->num_rows < 1) {
			...
			if (password_verify($password,$row["password"])) {
				...
				// Here we are updating user last login when he is performing login
...
$user = new User();
// echo $user->createUserAccount("jayesh","jayesh.jv@gmail.com","123456","Admin");

echo $user->userLogin("jayesh.jv@gmail.com","123456");
